...
export default function ThemeToggle() {
  ...
  return (
    <label className="inline-flex items-center relative">
      ...
      <div
        className="relative w-[80px] h-[40px] border bg-white peer-checked:bg-zinc-500 rounded-full after:absolute after:content-[''] after:w-[30px] after:h-[30px] after:bg-gradient-to-r from-orange-700 to-yellow-400 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[4px] after:left-[4px] active:after:w-[40px] peer-checked:after:left-[75px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"
      ></div>
      <svg
        height="0"
        width="100"
        ...
        className="fill-white peer-checked:opacity-60 absolute w-5 h-5 left-[9.5px]"
      >
        <path
