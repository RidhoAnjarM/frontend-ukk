                      ...
                      <div className="mt-[5px] flex flex-wrap" >
                        {forum.tags && forum.tags.length > 0 ? (
                          forum.tags.map((tag: any) => (
                            <span key={tag.id} className="py-[6px] px-[10px] text-[10px] font-ruda font-bold bg-putih3 dark:bg-hitam4 text-hitam2 dark:text-abu rounded-full me-[5px] mb-[5px] cursor-pointer hover:bg-ungu hover:text-white dark:hover:bg-ungu hover:underline" >
                              #{tag.name}
                            </span>
                          ))
                        ) : null
