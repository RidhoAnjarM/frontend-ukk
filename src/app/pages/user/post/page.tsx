...
const Posting = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setAlertMessage('Forum created successfully.');
            setShowAlert(true);
            ...
            let errorMessage = 'Failed to create forum';
            if (error.response) {
                switch (error.response.status) {
                    case 400:
                        errorMessage = 'Invalid data or already used.';
                        break;
                    case 500:
        ...
        <div className="w-[500px] mx-auto p-5 bg-white rounded-lg shadow-lg">
            <form onSubmit={handleSubmit}>
                ...
                <div className="relative mb-6">
                    <label htmlFor="file-upload" className="text-lg font-medium text-gray-700">Profile Photo</label>
                    <input
                        id="file-upload"
                        type="file"
                        accept="image/*"
