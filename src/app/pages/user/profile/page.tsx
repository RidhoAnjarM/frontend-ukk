...
const Profile = () => {
    ...
    if (!profile) return <div className='w-full h-screen bg-white dark:bg-hitam1 text-black dark:text-abu flex items-center justify-center' > Profil tidak ditemukan.</div>;
                ...
                < Modal isOpen={showEdit} onClose={() => setShowEdit(false)}>
                    <div className='px-4'>
                        ...
                        <div className="flex justify-between items-center mb-6" >
                            <h2 className="text-[24px] font-bold text-hitam1 dark:text-putih1" > Edit Profil </h2>
                        </div>
                        ...
                        <div className="space-y-4" >
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 bg-putih3 dark:bg-hitam3 border border-hitam2 dark:border-hitam3 rounded-[10px] text-hitam1 dark:text-abu focus:ring-2 focus:ring-ungu outline-none transition-all duration-200"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 bg-putih3 dark:bg-hitam3 border border-hitam2 dark:border-hitam3 rounded-[10px] text-hitam1 dark:text-abu focus:ring-2 focus:ring-ungu outline-none transition-all duration-200 placeholder:text-gray-400 dark:placeholder:text-gray-600"
                                />
                            </div>
                            <div>
                                ...
                                < input
                                    ...
                                    className="w-full p-2 bg-putih3 dark:bg-hitam3 border border-hitam2 dark:border-hitam3 rounded-[10px] text-hitam1 dark:text-abu file:mr-4 file:py-1 file:px-3 file:rounded-full file:border-0 file:bg-ungu file:text-white hover:file:bg-ungu-dark transition-all duration-200"
                                />
                            </div>
                        </div>
